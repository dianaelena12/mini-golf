...
public class ProblemXMLRepo extends InMemRepo<Long,Problem> {
    ...
    private static void saveToXML(Problem Problem) throws Exception {
        Document doc = DocumentBuilderFactory.newInstance().newDocumentBuilder()
                .parse("C:\\Users\\Diana\\Desktop\\mini-golf\\src\\main\\java\\springjpa.Data\\Problems.xml");
        ...
        transformer.transform(new DOMSource(root), new StreamResult(new
                FileOutputStream("C:\\Users\\Diana\\Desktop\\mini-golf\\src\\main\\java\\springjpa.Data\\Problems.xml")));
    }

    private static void deleteFromXML(Long id) throws Exception {
        DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
        DocumentBuilder db = dbf.newDocumentBuilder();
        Document doc = db.parse("C:\\Users\\Diana\\Desktop\\mini-golf\\src\\main\\java\\springjpa.Data\\Problems.xml");
