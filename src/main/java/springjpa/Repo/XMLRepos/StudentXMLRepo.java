...
public class StudentXMLRepo extends InMemRepo<Long, Student> {
    ...
    private void loadData() throws Exception{
        ...
        Document doc = db.parse("C:\\Users\\Diana\\Desktop\\mini-golf\\src\\main\\java\\springjpa.Data\\Students.xml");
    ...
    private static  Student createStudent(Element studentNode) {
        ...
        student.setGr(Integer.parseInt(getTextFromTagName(studentNode, "group")));
    ...
    private static void saveToXML(Student student) throws Exception {
        Document doc = DocumentBuilderFactory.newInstance().newDocumentBuilder()
                .parse("C:\\Users\\Diana\\Desktop\\mini-golf\\src\\main\\java\\springjpa.Data\\Students.xml");
        Element root = doc.getDocumentElement();
        ...
        appendChildWithText(doc, studentElement, "group", "" + student.getGr());

        Transformer transformer = TransformerFactory.newInstance().newTransformer();
        transformer.transform(new DOMSource(root), new StreamResult(new
                FileOutputStream("C:\\Users\\Diana\\Desktop\\mini-golf\\src\\main\\java\\springjpa.Data\\Students.xml")));
}
