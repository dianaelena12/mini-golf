...
public class StudentDBRepo extends DBRepo<Long, Student> {
    ...
    public Optional<Student> saveInDB(Student entity) {
        ...
        try (Connection connect = this.connectToDB();
            ...
            statement.setInt(1, entity.getGr());
    ...
    public Optional<Student> getFromDB(Long id) {
        ...
        try (Connection connect = this.connectToDB();
            ...
            if (resultSet.next()) {
                Student student = new Student(resultSet.getInt("Group"),
                        resultSet.getString("Name"), resultSet.getString("SerialNumber"));
    ...
    public Set<Student> findAllFromDB() {
        ...
        try (Connection connect = this.connectToDB();
            ...
            while (resultSet.next()) {
                ...
                Student student = new Student(group, name, serialNumber);
                student.setId(id);
